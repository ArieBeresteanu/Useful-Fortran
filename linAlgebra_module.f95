...
!--------1!--------2!--------3!--------4!--------5!--------6!--------7!--------8
  SUBROUTINE matinv(n,matIn,matOut)
	...
	INTEGER(regInt), INTENT(IN)		:: n !matrix dimension
...
INTEGER(regInt),DIMENSION(n)		:: indx
REAL(dp)							:: d
INTEGER(regInt)						:: i
...
INTEGER(regInt),DIMENSION(:),INTENT(IN) 	:: indx
REAL(dp),DIMENSION(:),INTENT(INOUT) :: b
!additional variables
INTEGER(regInt):: i,n,ii,ll
REAL(dp) :: summ
